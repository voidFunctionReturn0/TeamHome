...
public class AddScheduleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainActivity.startDate = "Start Date";
    ...
    private View.OnClickListener onClickListenerBtnFinishAddingSchedule = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            // 일정을 DB에 저장
            if(Network3.addSchedule(s) == false) { Toast.makeText (v.getContext(), "일정 추가 실패", Toast.LENGTH_LONG).show(); }
    ...
    // 영어 Month를 숫자로 변경
    private String engToNumMonth(String month) {
    ...
    private Integer[] newFormatToIntegerArr(String newFormat) {
        ...
        try {
            newFormat = newFormat.substring(1);
            Log.d("newFormat", "###"+newFormat+"###");
